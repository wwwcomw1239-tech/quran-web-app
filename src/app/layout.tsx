...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "نور القرآن - Noor Al-Quran",
    description: "استمع إلى تلاوات القرآن الكريم بصوت 100 قارئ واقرأ مكتبة من أكثر من 1100 كتاب إسلامي وشاهد المئات من دروس العلماء والمقاطع القصيرة والدورات",
    type: "website",
    images: [
      {
